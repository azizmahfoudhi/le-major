  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="text-center">
        <h1 className="font-display text-2xl font-bold text-navy-900">Bon retour</h1>
        <p className="text-sm text-navy-600 mt-1">Connectez-vous à votre espace étudiant</p>
      </div>
      ...
      <div className="text-center text-sm">
        <span className="text-navy-600">Pas encore de compte ?</span>{' '}
        <Link href={ROUTES.inscription} className="text-gold-600 font-medium hover:text-gold-700 transition-colors">
          Créer un compte
        </Link>
      </div>
      
      <div className="text-center text-sm">
        <Link href={ROUTES.activation} className="text-navy-500 hover:text-navy-700 transition-colors underline underline-offset-4">
